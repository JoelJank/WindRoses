...
from python.Functions.velmagplot import velmagplot
...
# for velocity plot : vmin = -0.002, vmax = 0.003
#v = 2 : vmin = -0.05, vmax = 0.075
# for vel plot: vmin = -0.02, vmax = 0.02
...
if __name__ == "__main__":
    ...
    shearstressdata = "Data/shearstressdata_2"
    ...
    for filename in sorted(os.listdir(shearstressdata)):
        if filename.endswith('_nodevalues_taux.npy'):
            ...
            velmagplot(taux, tauy, settings["meshgrid_params"], vmin = -0.02, vmax = 0.02,
                       velo = True, ax = axes[i], rectangles = settings["rectangles"], 
                       save_figure = False, 
                       safepath = None, 
                       figsize = settings["figsize"], 
                       colormap = settings["colormap"], 
    ...
    plt.savefig("velmagplot_2.png", dpi = 300, bbox_inches = "tight")
